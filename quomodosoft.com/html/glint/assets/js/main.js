(function ($) {
  ...
  jQuery(document).ready(function ($) {
    ...
    wlc_slide.on("translate.owl.carousel", function () {
      $(".welcome-carousel .wlc-title h1")
        .removeClass("fadeInDown animated")
        .hide();
      $(".welcome-carousel .wlc-title p")
        .removeClass("fadeInDown animated")
        .hide();
      $(".welcome-carousel .wlc-title a")
        .removeClass("fadeInDown animated")
        .hide();
      $(".welcome-carousel h1.wlc-filltext")
        .removeClass("fadeInDown animated")
        .hide();
    });
    wlc_slide.on("translated.owl.carousel", function () {
      $(".owl-item.active .wlc-title h1")
      ...
      $(".owl-item.active h1.wlc-filltext")
        .addClass("fadeInDown animated")
        .show();
    });
